    ...
    <div className="flex-1 flex flex-col overflow-y-auto bg-white text-stone-800">
      ...
      <div className="p-3 border-b border-stone-200 bg-white/80 backdrop-blur flex justify-between items-center shrink-0">
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className={cn(
              ...
              isEditMode 
                ? "bg-wood-600 text-white shadow-inner" 
                : "bg-stone-100 text-stone-600 hover:bg-stone-200"
            )}
          >
            {isEditMode ? <Move size={14} /> : <Edit2 size={14} />}
            {isEditMode ? '编辑模式' : '滚动模式'}
          </button>
          <div className="h-4 w-px bg-stone-200" />
          <button
            ...
            className={cn(
              ...
              showFilters || selectedLocationIds.length > 0 || tagFilter.includedIds.length > 0 || tagFilter.excludedIds.length > 0
                ? "bg-wood-100 text-wood-700 border border-wood-200" 
          ...
          >
            ...
            {(selectedLocationIds.length > 0 || tagFilter.includedIds.length > 0 || tagFilter.excludedIds.length > 0) && (
              <span className="bg-wood-500 text-white text-[9px] px-1.5 py-0.5 rounded-full ml-1">
        ...
        <div className="flex items-center gap-2 text-[10px] text-stone-400 italic">
          <Info size={12} />
          {isEditMode ? '拖动卡片以重新定位' : '水平拖动或滚动以浏览时间'}
        </div>
      </div>
            ...
            <div className="p-4 flex flex-col gap-4">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          isSelected 
                            ? "bg-wood-100 text-wood-800 border-wood-300" 
                  ...
                  {locations.length === 0 && <span className="text-xs text-stone-400 italic">无可用地点</span>}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                    ...
                    return (
                      <div 
                        ...
                        className={cn(
                          ...
                          isIncluded ? "border-wood-300 bg-wood-50" : 
                      ...
                      >
                        <button
                          ...
                          className={cn(
                            ...
                            isIncluded ? "text-wood-800 hover:bg-wood-100 border-wood-200" : 
                  ...
                  {tags.length === 0 && <span className="text-xs text-stone-400 italic">无可用标签</span>}
                </div>
              </div>
          ...
          >
            ...
            <div className="sticky left-0 z-20 h-full w-40 bg-stone-100/95 backdrop-blur border-r border-stone-200 flex items-center px-4 gap-3 shrink-0">
              ...
              <div className="flex flex-col min-w-0">
                <span className="text-xs font-bold text-stone-800 truncate">所有事件</span>
                <span className="text-[9px] text-stone-400 uppercase tracking-tighter truncate">主轨道</span>
              </div>
            </div>
              ...
              return (
                <motion.div
                  ...
                  className={cn(
                    ...
                    isHovered ? "ring-2 ring-wood-500 z-40" : "z-10",
                    isEditMode ? "hover:border-wood-400 cursor-move" : "cursor-pointer"
                  )}
                  style={{ 
                    left: xScale(event.startTime) + 160, 
                    width: width,
                    top: 20 + (event.level * 45),
                    backgroundColor: isHovered ? '#9c8462' : '#ffffff',
                    borderColor: isHovered ? '#b8a384' : '#e5e7eb'
                  }}
                ...
                >
                  ...
                  {isEditMode && (
                    <div 
                      className="resize-handle absolute right-0 top-0 bottom-0 w-3 cursor-ew-resize hover:bg-wood-400/30 transition-colors z-50 flex items-center justify-center group/handle"
                      data-event-id={event.id}
                    >
                      <div className="w-1 h-4 bg-wood-500/50 rounded-full opacity-0 group-hover/handle:opacity-100" />
                    </div>
                  )}
                </motion.div>
              );
          ...
          <div className="relative">
              ...
              >
                ...
                <div className="sticky left-0 z-20 h-full w-40 bg-white/95 backdrop-blur border-r border-stone-200 flex items-center px-4 gap-3 shrink-0">
                  ...
                  <div className="flex flex-col min-w-0">
                    ...
                    <span className="text-[9px] text-stone-400 uppercase tracking-tighter truncate">轨道</span>
                  </div>
                </div>
                    ...
                    return (
                      <motion.div
                        ...
                        style={{ 
                          left: xScale(event.startTime) + 160, 
                          width: width,
                          backgroundColor: isHovered ? '#9c8462' : '#f5f5f4',
                          borderColor: isHovered ? '#b8a384' : '#e5e7eb'
                        }}
                        onMouseEnter={() => setHoveredEventId(event.id)}
                        onMouseLeave={() => setHoveredEventId(null)}
                        ...
                        <div className="px-3 py-1 h-full flex flex-col justify-center">
                          ...
                          {width > 60 && (
                            <span className={cn(
                              ...
                              isHovered ? "text-wood-100" : "text-stone-500"
                            )}>
            ...
            >
              <div className="sticky left-0 z-20 h-full w-40 bg-white/95 backdrop-blur border-r border-stone-200 flex items-center px-4 gap-3 shrink-0">
                ...
                <div className="flex flex-col min-w-0">
                  <span className="text-xs font-bold text-stone-800 truncate">全局</span>
                  <span className="text-[9px] text-stone-400 uppercase tracking-tighter truncate">世界</span>
                </div>
              </div>
                  ...
                  <>
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {Object.keys(event.characterActions || {}).map(id => {
                        ...
                        return char ? (
                          <span key={id} className="text-[9px] font-bold uppercase tracking-wider bg-wood-50 text-wood-700 border border-wood-200/50 px-2 py-0.5 rounded-md shadow-sm">
                            {char.name}
                          </span>
                        ) : null;
                      })}
      ...
      <div className="absolute bottom-20 right-6 z-50 w-64 h-16 bg-white/90 backdrop-blur-md border border-stone-200 rounded-lg shadow-lg overflow-hidden flex flex-col">
        ...
        >
          ...
          <div className="absolute inset-x-2 inset-y-1 opacity-40 pointer-events-none">
            {processedEvents.map(event => {
              ...
              return (
                <div
                  key={`mini-${event.id}`}
                  className="absolute bg-wood-500 rounded-sm"
                  style={{
                    left: `${leftPercent}%`,
                    width: `${widthPercent}%`,
          ...
          {/* Viewport Indicator */}
          <div 
            className="absolute top-0 bottom-0 bg-wood-500/10 border-x border-wood-500/50 transition-all duration-75 pointer-events-none group-hover:bg-wood-500/20"
            style={{
