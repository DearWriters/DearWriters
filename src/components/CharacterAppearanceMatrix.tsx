  ...
  return (
    <div className="overflow-x-auto custom-scrollbar">
      <table className="min-w-full border-collapse">
        <thead>
          <tr>
            <th className="sticky left-0 z-10 bg-white border-b border-stone-200 p-2 text-left text-[10px] font-bold text-stone-400 uppercase tracking-wider shadow-[2px_0_5px_-2px_rgba(0,0,0,0.05)]">场景</th>
                    ...
                    <div className="relative flex items-center justify-center">
                      <button
                        ...
                        className={cn(
                          ...
                          isPresent ? "bg-wood-100 text-wood-600 hover:bg-wood-200" : "bg-stone-100 text-stone-300 hover:bg-stone-200"
                        )}
                      >
                        <Check size={14} />
                      </button>
                        ...
                        {isPresent && (
                          <button
                            ...
                            className={cn(
                              ...
                              note ? "text-wood-600 hover:bg-wood-100" : "text-stone-300 hover:bg-stone-100 hover:text-stone-500"
                            )}
                          >
      ...
      {noteModal.isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-white p-6 rounded-lg shadow-xl w-96">
            <h3 className="text-lg font-bold mb-4">编辑笔记</h3>
            <textarea
            ...
            <div className="flex justify-end gap-2">
              <button onClick={closeNoteModal} className="px-4 py-2 bg-stone-200 rounded">取消</button>
              <button onClick={saveNote} className="px-4 py-2 bg-wood-600 text-white rounded">保存</button>
            </div>
          </div>
        </div>
      )}
