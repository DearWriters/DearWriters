              ...
              <div className="space-y-4">
                {characterCount === 0 ? (
                  <div className="text-center py-12 px-4 border-2 border-dashed border-stone-200 rounded-xl bg-stone-50/50">
                    ...
                    <h4 className="text-sm font-medium text-stone-600 mb-1">没有涉及角色</h4>
                    <p className="text-xs text-stone-400">在上方选择角色以描述他们在此事件中的行为。</p>
                  </div>
                ) : (
          ...
          {activeTab === 'relations' && (
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="bg-white p-5 rounded-xl border border-stone-200 shadow-sm">
                  <p className="text-xs text-stone-500 mb-4">水平固定事件以保持固定的间隔。</p>
                  <MultiSelectDropdown
                    options={allEvents.map(e => ({ id: e.id, title: e.title }))}
              ...
              <div>
                ...
                <div className="bg-white p-5 rounded-xl border border-stone-200 shadow-sm">
                  <p className="text-xs text-stone-500 mb-4">垂直同步事件以将它们堆叠。</p>
                  <MultiSelectDropdown
                    options={allEvents.map(e => ({ id: e.id, title: e.title }))}
