        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-3 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <h1 className="hidden sm:flex text-xl sm:text-2xl font-bold text-stone-800 items-center gap-2">
              <MessageSquare size={24} className="text-wood-600" /> 剧本
            </h1>
            ...
            <div className="px-4 sm:px-6 py-3 border-b border-stone-100 flex flex-col sm:flex-row sm:items-center justify-between bg-stone-50/50 gap-3">
              ...
              <div className="flex items-center gap-2 self-end sm:self-auto">
                <button 
                  ...
                  className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-wood-700 bg-wood-50 hover:bg-wood-100 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <Play size={16} />
                  沉浸播放
                </button>
                    ...
                    >
                      ...
                      >
                        ...
                        <button 
                          ...
                          className="absolute -right-8 top-1/2 -translate-y-1/2 p-1.5 text-stone-300 hover:text-wood-500 opacity-0 group-hover:opacity-100 transition-opacity"
                          title="编辑此行"
                        >
                          <Edit2 size={16} />
                        </button>
              ...
              <div className="bg-white border-t border-stone-200 p-4 shadow-[0_-10px_40px_-15px_rgba(0,0,0,0.05)] z-10">
                <div className="max-w-4xl mx-auto">
                  ...
                  <div className="relative flex flex-col sm:flex-row items-stretch sm:items-end gap-2">
                    <div className={cn(
                      "flex-1 flex flex-col border rounded-xl overflow-hidden transition-colors focus-within:border-wood-500 focus-within:ring-1 focus-within:ring-wood-500",
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        editingLineId ? "bg-wood-600 text-white hover:bg-wood-700" : "bg-stone-900 text-white hover:bg-stone-800"
                      )}
                    >
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start mb-4 gap-2">
                        ...
                        {editingDraftId === draft.id ? (
                          <div className="flex items-center gap-2 mb-1">
                            <input
                              ...
                              className="flex-1 px-2 py-1 text-lg font-bold border border-wood-500 rounded outline-none focus:ring-2 focus:ring-wood-200"
                            />
                            <button onClick={handleSaveDraftTitle} className="p-1 text-wood-600 hover:bg-wood-50 rounded"><Check size={18} /></button>
                          ...
                          <div className="flex items-center gap-2 group/title">
                            ...
                            <button 
                              ...
                              className="p-1 text-stone-300 hover:text-wood-600 opacity-0 group-hover/title:opacity-100 transition-opacity"
                              title="修改标题"
                            >
                              <Edit2 size={14} />
                            </button>
                      ...
                      <div className="flex items-center gap-1 self-end sm:self-auto">
                        <button 
                          ...
                          className="p-2 text-stone-400 hover:text-wood-600 hover:bg-wood-50 rounded-lg transition-colors"
                          title="载入剧本继续编辑"
                        >
                          <Edit2 size={16} />
                        </button>
                      ...
                      <div className="flex-1">
                        {selectedDraftId === draft.id ? (
                          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                            ...
                            <div className="flex gap-2">
                              <button 
                                ...
                                className="flex-1 sm:flex-none justify-center px-4 py-2 bg-wood-600 text-white rounded-lg hover:bg-wood-700 disabled:opacity-50 text-sm font-medium flex items-center gap-1"
                              >
                                <Check size={16} /> 确认插入
                              </button>
                              <button 
                          ...
                          <button 
                            ...
                            className="text-sm font-medium text-wood-600 hover:text-wood-700 flex items-center gap-1"
                          >
