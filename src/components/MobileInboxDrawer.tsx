      ...
      <div className="fixed inset-x-0 bottom-0 z-50 md:hidden bg-stone-50 rounded-t-2xl shadow-2xl flex flex-col transition-transform duration-300 ease-out transform translate-y-0" style={{ maxHeight: '85vh' }}>
        ...
        <div className="px-4 pb-2 flex items-center justify-between border-b border-stone-200">
          <h2 className="text-lg font-bold text-stone-800 flex items-center gap-2">
            <Inbox size={20} className="text-wood-600" />
            Notes
          </h2>
          ...
          <div className="flex gap-2">
            ...
            {activeWorkId && (
              <button 
                ...
                className={cn(
                  "flex-1 py-1.5 rounded-lg text-xs font-medium flex items-center justify-center gap-1.5 transition-colors",
                  noteScope === 'work' ? "bg-wood-600 text-white" : "bg-white text-stone-600 border border-stone-200"
                )}
              >
                <Book size={14} /> Work
              </button>
          ...
          <div className="bg-white p-3 rounded-xl border border-stone-200 shadow-sm">
              ...
              <div className="flex items-center gap-2 mt-2 pt-2 border-t border-stone-100">
                ...
                <div className="relative flex-1">
                  <select
                    ...
                    className="w-full appearance-none bg-stone-50 border border-stone-200 text-stone-700 text-xs rounded px-2 py-1.5 pr-6 focus:outline-none focus:ring-1 focus:ring-wood-500"
                  >
            ...
            <div className="flex justify-end mt-2 pt-2 border-t border-stone-100">
              <button
                ...
                className="px-3 py-1.5 bg-wood-600 text-white rounded-lg hover:bg-wood-700 disabled:opacity-50 text-xs font-medium flex items-center gap-1"
              >
                <Plus size={14} />
                Save
              </button>
                  ...
                  {editingId === item.id ? (
                    <div className="space-y-2">
                      <textarea
                        ...
                        className="w-full text-sm bg-stone-50 border border-stone-200 rounded-lg p-2 outline-none focus:ring-2 focus:ring-wood-500/20 focus:border-wood-500 resize-none min-h-[60px]"
                        autoFocus
                      />
                      <div className="flex justify-end gap-2">
                        ...
                        <button
                          ...
                          className="px-2 py-1 text-xs font-medium bg-wood-100 text-wood-700 hover:bg-wood-200 rounded-md flex items-center gap-1"
                        >
                          <Check size={14} />
                          Save
                        </button>
