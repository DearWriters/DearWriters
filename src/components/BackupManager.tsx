      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden flex flex-col max-h-[90vh]">
        <div className="p-4 border-b border-stone-100 flex items-center justify-between bg-stone-50 shrink-0">
          <h3 className="font-semibold text-stone-900 flex items-center">
            <Save size={18} className="mr-2 text-wood-600" />
          ...
          <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center text-sm font-medium text-stone-700">
                    <Cloud size={16} className="mr-2 text-wood-500" />
                    Supabase Cloud Sync
                  </div>
                  <button
                    ...
                    className={cn(
                      "relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-wood-500 focus:ring-offset-2",
                      supabaseSyncEnabled ? "bg-wood-500" : "bg-stone-200",
                ...
                {syncPrompt && (
                  <div className="p-4 bg-wood-50 border border-wood-100 rounded-lg space-y-3 animate-in fade-in slide-in-from-top-2">
                    <div className="text-sm font-medium text-wood-900">Cloud Data Found</div>
                    <div className="text-xs text-wood-800">
                      We found existing data in the cloud. How would you like to initialize sync?
                    </div>
                    <div className="text-[10px] text-wood-700 space-y-1">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        {(syncPrompt.cloudState.lastDevice || syncPrompt.cloudState._device) && (
                          <span className="flex items-center text-[10px] text-wood-600 bg-wood-100 px-1.5 py-0.5 rounded ml-1" title={`Saved from ${syncPrompt.cloudState.lastDevice || syncPrompt.cloudState._device}`}>
                    ...
                    <div className="flex gap-2 pt-2">
                      <button
                        ...
                        className="flex-1 px-3 py-2 bg-white border border-wood-200 text-wood-700 rounded-md text-xs font-medium hover:bg-wood-50 transition-colors"
                      >
                        Use Cloud Data
                      </button>
                      <button
                        onClick={() => handleSyncChoice('local')}
                        className="flex-1 px-3 py-2 bg-wood-600 text-white rounded-md text-xs font-medium hover:bg-wood-700 transition-colors"
                      >
                        Keep Local Data
                      </button>
                    </div>
                    <button
                      ...
                      className="w-full px-3 py-1.5 bg-transparent text-wood-600 hover:text-wood-800 text-xs text-center"
                    >
                      Cancel
                    </button>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 bg-stone-50 border border-stone-200 rounded-md text-xs focus:outline-none focus:ring-2 focus:ring-wood-500"
                    />
                  </div>
                  <div className="space-y-2">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center w-full px-3 py-2 bg-wood-600 text-white rounded-md text-xs font-medium hover:bg-wood-700 transition-colors"
                  >
                  ...
                  <div className="space-y-3">
                    ...
                    {supabaseSyncEnabled && (
                      <div className={cn(
                        ...
                        syncStatus === 'syncing' ? "bg-wood-50 border-wood-100 text-wood-700" :
                        syncStatus === 'success' ? "bg-wood-50 border-wood-100 text-wood-700" :
                    ...
                    {pullStatus && (
                      <div className={cn(
                        "text-xs p-2 rounded",
                        pullStatus.type === 'error' ? "bg-red-50 text-red-600" : "bg-wood-50 text-wood-600"
                      )}>
                        {pullStatus.message}
                      </div>
                    )}
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            <button
                              ...
                              className="px-2 py-1 text-[10px] font-medium text-wood-600 bg-wood-50 border border-wood-100 rounded hover:bg-wood-100 transition-colors"
                            >
                              Save Version Now
                            </button>
                            <button
                              ...
                              <div key={item.id} className="flex flex-col p-2 hover:bg-stone-50">
                                <div className="flex items-center justify-between">
                                  <div className="text-xs text-stone-700 flex items-center gap-2">
                                    ...
                                    {index === 0 && <span className="text-[10px] bg-wood-100 text-wood-700 px-1.5 py-0.5 rounded">Latest</span>}
                                  </div>
                                  {confirmRestoreId !== item.id && (
                                    <button
                                      onClick={() => setConfirmRestoreId(item.id)}
                                      className="text-[10px] font-medium text-wood-600 hover:text-wood-700 hover:underline px-2 py-1"
                                    >
                                      Restore
                                    </button>
                                  )}
                                  ...
                                  <div className="mt-2 p-2 bg-amber-50 border border-amber-100 rounded text-[10px] text-amber-800 flex flex-col gap-2">
                                    ...
                                    <div className="flex gap-2 justify-end">
                                      ...
                                      <button 
                                        ...
                                        className="px-2 py-1 bg-wood-600 text-white rounded hover:bg-wood-700"
                                      >
                                        Yes, Restore
                                      </button>
                                    </div>
            ...
            {isSupported && (
              <>
                <div className="space-y-4">
                  ...
                  {directoryHandle ? (
                    <div className="p-3 bg-wood-50 border border-wood-100 rounded-lg">
                      <div className="text-xs text-wood-800 font-medium truncate mb-1">
                        {directoryHandle.name}
                      </div>
                      <div className="text-[10px] text-wood-600 flex items-center">
                ...
                <div className="space-y-3 pt-4 border-t border-stone-100">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className={cn(
                        "relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-wood-500 focus:ring-offset-2",
                        isBackupEnabled ? "bg-wood-500" : "bg-stone-200",
                ...
                <div className="pt-4 border-t border-stone-100 space-y-2">
                  ...
                  {statusMessage && (
                    <div className={cn(
                      ...
                      statusType === 'success' ? "bg-wood-50 text-wood-600" : 
