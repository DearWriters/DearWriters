...
export function WorkIconPicker({ currentIcon, onSelect, children }: WorkIconPickerProps) {
  ...
  const popoverContent = isOpen ? (
    ...
    >
      <div className="mb-3">
        <h4 className="text-xs font-semibold text-stone-500 uppercase tracking-wider mb-2">颜色</h4>
      ...
      <div className="mb-3">
        <h4 className="text-xs font-semibold text-stone-500 uppercase tracking-wider mb-2">常用表情</h4>
      ...
      <div>
        <h4 className="text-xs font-semibold text-stone-500 uppercase tracking-wider mb-2">自定义表情</h4>
        <form onSubmit={handleCustomEmojiSubmit} className="flex gap-2">
          <input
            ...
            placeholder="粘贴一个表情..."
            className="flex-1 text-sm px-2 py-1.5 border border-stone-200 rounded outline-none focus:border-wood-500 focus:ring-1 focus:ring-wood-500"
